...
import "./page.css";
import { getSessionFx, pageMounted } from "../../entities/auth/session";

const { Content } = Layout;
const { Title, Paragraph } = Typography;

export const HomePage = () => {
  const [pageMountedFn, loading] = useUnit([pageMounted, getSessionFx.pending]);
  useEffect(() => pageMountedFn, [pageMountedFn]);
